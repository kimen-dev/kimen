...
import { defineCustomElement } from '../dist/components/ki-radio-group.js';

type KiRadioGroupElement = HTMLElement & { label: string };
...
async function mount(): Promise<KiRadioGroupElement> {
