...
import { defineCustomElement } from '../dist/components/ki-tabs.js';

type KiTabsElement = HTMLElement & { label: string };
...
async function mount(): Promise<KiTabsElement> {
  const el = document.createElement('ki-tabs') as KiTabsElement;
...
describe('ki-tabs in a real browser', () => {
