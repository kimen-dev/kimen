...
import { defineCustomElement } from '../dist/components/ki-list.js';

type KiListElement = HTMLElement & { label: string };
...
async function mount(): Promise<KiListElement> {
  const el = document.createElement('ki-list') as KiListElement;
