...
[ki-button](/docs/components/button/):
...
Pair with [ki-tooltip](/docs/components/tooltip/) for sighted
...
fits, use [ki-button](/docs/components/button/) instead.
...
[Open ki-icon-button in Storybook](/storybook/?path=/docs/docs-components-ki-icon-button--docs)
